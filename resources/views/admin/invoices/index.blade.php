    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="{{ route('admin.invoices.create') }}" class="btn btn-sm btn-info">New</a>
            </div>
        </div>
        <div class="card-body">
        ...
        @foreach($invoices as $invoice)
                <tr>
                    ...
                    <a type="button" class="btn btn-primary" href="{{ route('admin.invoices.show', encrypt($invoice->id) ) }}" target="_blank">
